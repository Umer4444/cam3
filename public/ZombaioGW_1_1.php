<?php
	...
	// AT: http://dev.xexposed.com/ZombaioGW_1_1.php
	//----------------------------------------------------------------
	//
	// File Generated:  2015-11-10
	// Generated for:   ambitious productions
	// Site Name:       CamClients.com
	// Site ID:         287656154
	...
	$cfgSiteName	= "CamClients.com";
	$catalog 	= "members";
	$ZombaioGWPass	= "49CN3I3166BVW2YLN196";
	...
	$path  = __DIR__ . '/../data/Zombaio_Data';
	...
	//-----------------------------------------------------------------------
	// COPYRIGHT (C) 2015 - ZOMBAIO.COM, ALL RIGHTS RESERVED
	//-----------------------------------------------------------------------
	?>
