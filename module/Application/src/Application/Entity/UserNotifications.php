...
class UserNotifications
{
    ...
    protected $date;
    /**
     * @ORM\Column(name="resource", type="integer",  nullable=true, options={"default" = 0})
     *
     * @var mixed
     */
    protected $resource;
    /**
     * @ORM\Column(name="linked_resource", type="integer",  nullable=true, options={"default" = 0})
     *
     * @var mixed
     */
