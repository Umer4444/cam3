...
class BaseInteractionController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\Interaction';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\InteractionForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\InteractionFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/interaction/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\InteractionGrid');
