...
class BaseResourceValuesController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\ResourceValues';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\ResourceValuesForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\ResourceValuesFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/resource-values/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\ResourceValuesGrid');
