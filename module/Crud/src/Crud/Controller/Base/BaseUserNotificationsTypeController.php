...
class BaseUserNotificationsTypeController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\UserNotificationsType';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\UserNotificationsTypeForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\UserNotificationsTypeFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/user-notifications-type/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\UserNotificationsTypeGrid');
