...
class BaseMagentoSessionController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\MagentoSession';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\MagentoSessionForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\MagentoSessionFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/magento-session/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\MagentoSessionGrid');
