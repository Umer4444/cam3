...
class BaseInteractionsController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\Interactions';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\InteractionsForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\InteractionsFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/interactions/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\InteractionsGrid');
