...
class BaseUserAccessController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\UserAccess';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\UserAccessForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\UserAccessFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/user-access/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\UserAccessGrid');
