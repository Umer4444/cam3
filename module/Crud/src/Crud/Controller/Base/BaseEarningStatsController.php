...
class BaseEarningStatsController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\EarningStats';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\EarningStatsForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\EarningStatsFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/earning-stats/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\EarningStatsGrid');
