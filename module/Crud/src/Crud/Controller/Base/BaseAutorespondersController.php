...
class BaseAutorespondersController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\Autoresponders';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\AutorespondersForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\AutorespondersFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/autoresponders/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\AutorespondersGrid');
