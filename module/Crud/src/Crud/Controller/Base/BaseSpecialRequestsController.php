...
class BaseSpecialRequestsController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\SpecialRequests';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\SpecialRequestsForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\SpecialRequestsFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/special-requests/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\SpecialRequestsGrid');
