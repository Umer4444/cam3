...
class BaseOrderLineController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\OrderLine';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\OrderLineForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\OrderLineFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/order-line/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\OrderLineGrid');
