...
class BaseAnnouncementsController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\Announcements';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\AnnouncementsForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\AnnouncementsFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/announcements/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\AnnouncementsGrid');
