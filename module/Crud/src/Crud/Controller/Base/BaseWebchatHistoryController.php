...
class BaseWebchatHistoryController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\WebchatHistory';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\WebchatHistoryForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\WebchatHistoryFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/webchat-history/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\WebchatHistoryGrid');
