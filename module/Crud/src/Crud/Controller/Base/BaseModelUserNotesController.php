...
class BaseModelUserNotesController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\ModelUserNotes';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\ModelUserNotesForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\ModelUserNotesFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/model-user-notes/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\ModelUserNotesGrid');
