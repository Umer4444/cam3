...
class BaseManagersStudiosController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\ManagersStudios';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\ManagersStudiosForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\ManagersStudiosFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/managers-studios/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\ManagersStudiosGrid');
