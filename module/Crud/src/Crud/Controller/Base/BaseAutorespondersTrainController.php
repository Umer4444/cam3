...
class BaseAutorespondersTrainController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\AutorespondersTrain';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\AutorespondersTrainForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\AutorespondersTrainFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/autoresponders-train/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\AutorespondersTrainGrid');
