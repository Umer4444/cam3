...
class BaseContactCompanyController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\ContactCompany';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\ContactCompanyForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\ContactCompanyFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/contact-company/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\ContactCompanyGrid');
