...
class BaseNotificationsController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\Notifications';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\NotificationsForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\NotificationsFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/notifications/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\NotificationsGrid');
