...
class BaseVideoToCategoriesController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\VideoToCategories';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\VideoToCategoriesForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\VideoToCategoriesFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/video-to-categories/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\VideoToCategoriesGrid');
