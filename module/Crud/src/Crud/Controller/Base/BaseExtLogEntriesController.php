...
class BaseExtLogEntriesController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\ExtLogEntries';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\ExtLogEntriesForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\ExtLogEntriesFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/ext-log-entries/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\ExtLogEntriesGrid');
