...
class BasePaymentSessionController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\PaymentSession';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\PaymentSessionForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\PaymentSessionFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/payment-session/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\PaymentSessionGrid');
