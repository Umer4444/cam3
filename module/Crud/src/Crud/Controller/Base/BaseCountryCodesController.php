...
class BaseCountryCodesController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\CountryCodes';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\CountryCodesForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\CountryCodesFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/country-codes/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\CountryCodesGrid');
