...
class BaseModelModeratorController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\ModelModerator';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\ModelModeratorForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\ModelModeratorFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/model-moderator/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\ModelModeratorGrid');
