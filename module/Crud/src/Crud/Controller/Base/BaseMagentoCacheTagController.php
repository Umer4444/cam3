...
class BaseMagentoCacheTagController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\MagentoCacheTag';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\MagentoCacheTagForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\MagentoCacheTagFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/magento-cache-tag/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\MagentoCacheTagGrid');
