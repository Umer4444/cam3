...
class BaseTransferWallController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\TransferWall';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\TransferWallForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\TransferWallFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/transfer-wall/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\TransferWallGrid');
