...
class BaseOrderFlagLinkerController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\OrderFlagLinker';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\OrderFlagLinkerForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\OrderFlagLinkerFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/order-flag-linker/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\OrderFlagLinkerGrid');
