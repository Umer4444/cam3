...
class BaseCountryProvinceController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\CountryProvince';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\CountryProvinceForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\CountryProvinceFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/country-province/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\CountryProvinceGrid');
