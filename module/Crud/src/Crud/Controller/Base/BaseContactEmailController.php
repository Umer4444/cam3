...
class BaseContactEmailController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\ContactEmail';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\ContactEmailForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\ContactEmailFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/contact-email/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\ContactEmailGrid');
