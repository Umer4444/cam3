...
class BaseWebchatSessionsController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\WebchatSessions';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\WebchatSessionsForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\WebchatSessionsFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/webchat-sessions/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\WebchatSessionsGrid');
