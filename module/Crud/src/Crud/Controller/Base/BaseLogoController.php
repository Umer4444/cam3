...
class BaseLogoController extends \Crud\Controller\ActionController
{
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\LogoForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\LogoFilter');
