...
class BaseUserNotificationsMailController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\UserNotificationsMail';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\UserNotificationsMailForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\UserNotificationsMailFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/user-notifications-mail/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\UserNotificationsMailGrid');
