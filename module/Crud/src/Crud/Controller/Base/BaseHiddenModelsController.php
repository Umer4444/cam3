...
class BaseHiddenModelsController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\HiddenModels';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\HiddenModelsForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\HiddenModelsFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/hidden-models/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\HiddenModelsGrid');
