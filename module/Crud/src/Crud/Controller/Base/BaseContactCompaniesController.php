...
class BaseContactCompaniesController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\ContactCompanies';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\ContactCompaniesForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\ContactCompaniesFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/contact-companies/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\ContactCompaniesGrid');
