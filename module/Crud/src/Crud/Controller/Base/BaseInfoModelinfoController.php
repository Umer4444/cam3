...
class BaseInfoModelinfoController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\InfoModelinfo';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\InfoModelinfoForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\InfoModelinfoFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/info-modelinfo/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\InfoModelinfoGrid');
