...
class BaseModelUserAccessController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\ModelUserAccess';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\ModelUserAccessForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\ModelUserAccessFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/model-user-access/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\ModelUserAccessGrid');
