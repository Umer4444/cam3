...
class BaseUserRoleLinkerController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\UserRoleLinker';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\UserRoleLinkerForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\UserRoleLinkerFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/user-role-linker/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\UserRoleLinkerGrid');
