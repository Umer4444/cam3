...
class BaseBlogPostsController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\BlogPosts';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\BlogPostsForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\BlogPostsFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/blog-posts/list');
            }
        }
