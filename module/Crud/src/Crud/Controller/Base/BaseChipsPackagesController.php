...
class BaseChipsPackagesController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\ChipsPackages';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\ChipsPackagesForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\ChipsPackagesFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/chips-packages/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\ChipsPackagesGrid');
