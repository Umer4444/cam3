...
class BaseWebcamAccessController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\WebcamAccess';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\WebcamAccessForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\WebcamAccessFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/webcam-access/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\WebcamAccessGrid');
