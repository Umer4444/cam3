...
class BaseUserStudiosController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\UserStudios';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\UserStudiosForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\UserStudiosFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/user-studios/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\UserStudiosGrid');
