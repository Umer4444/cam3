...
class BasePurchasedContentController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\PurchasedContent';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\PurchasedContentForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\PurchasedContentFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/purchased-content/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\PurchasedContentGrid');
