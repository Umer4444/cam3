...
class BaseContactAddressesController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\ContactAddresses';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\ContactAddressesForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\ContactAddressesFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/contact-addresses/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\ContactAddressesGrid');
