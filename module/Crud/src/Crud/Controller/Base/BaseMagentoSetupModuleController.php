...
class BaseMagentoSetupModuleController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\MagentoSetupModule';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\MagentoSetupModuleForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\MagentoSetupModuleFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/magento-setup-module/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\MagentoSetupModuleGrid');
