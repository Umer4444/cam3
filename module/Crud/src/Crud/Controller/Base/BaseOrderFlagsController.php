...
class BaseOrderFlagsController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\OrderFlags';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\OrderFlagsForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\OrderFlagsFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/order-flags/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\OrderFlagsGrid');
