...
class BaseUserRoleController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\UserRole';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\UserRoleForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\UserRoleFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/user-role/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\UserRoleGrid');
