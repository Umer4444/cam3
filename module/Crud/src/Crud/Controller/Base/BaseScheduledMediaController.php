...
class BaseScheduledMediaController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\ScheduledMedia';
    ...
    public function createAction()
    {
        ...
        $filter = $this->getServiceLocator()->get('\Crud\Filter\ScheduledMediaFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/scheduled-media/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\ScheduledMediaGrid');
