...
class BaseModelRatesPendingController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\ModelRatesPending';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\ModelRatesPendingForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\ModelRatesPendingFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/model-rates-pending/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\ModelRatesPendingGrid');
