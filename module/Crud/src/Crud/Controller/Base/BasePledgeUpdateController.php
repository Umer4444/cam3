...
class BasePledgeUpdateController extends \Crud\Controller\ActionController
{

    public $entity = '\\Application\\Entity\\PledgeUpdate';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\PledgeUpdateForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\PledgeUpdateFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/pledge-update/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\PledgeUpdateGrid');
