...
class ChatBackgroundController extends Base\BaseScheduledMediaController
{

    public $entity = '\\Application\\Entity\\ChatBackground';
    ...
    public function createAction()
    {
        ...
        if ($request->isPost()) {
            ...
            $row = new \Application\Entity\ChatBackground();
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/chat-background/list');
            }
        }
    ...
    public function updateAction()
    {
        ...
        $em = $this->getServiceLocator()->get("em");
        $row = $em->find('\Application\Entity\ChatBackground', $id);
        $form = $this->getServiceLocator()->get('\Crud\Form\ScheduledMediaForm');
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\ChatBackgroundGrid');
