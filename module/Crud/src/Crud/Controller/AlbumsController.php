...
class AlbumsController extends \Crud\Controller\ActionController
{

    public $entity = '\Images\Entity\Albums';
    ...
    {
        $form = $this->getServiceLocator()->get('\Crud\Form\AlbumsForm');
        $request = $this->getRequest();

        $filter = $this->getServiceLocator()->get('\Crud\Filter\AlbumsFilter');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toUrl('/admin/crud/albums/list');
            }
        }
    ...
    public function ajaxListAction()
    {
        ...
        $table = $this->getServiceLocator()->get('\Crud\Grid\AlbumsGrid');
