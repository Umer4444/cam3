<?php
/**
 * This file is generated automatically for table "earning_stats". Do not change
...
class BaseEarningStatsGrid extends \ZfTable\AbstractTable
{
    ...
    public function init()
    {
        ...
        $this->getHeader("edit")->getCell()->addDecorator("callable", array(
            "callable" => function($context, $record){
                return sprintf("<a href=\"/admin/crud/earning-stats/update/%s\">Edit</a>", $record->getId());//id
            }
        ));

        $this->getHeader("delete")->getCell()->addDecorator("callable", array(
            "callable" => function($context, $record){
                return sprintf("<a href=\"/admin/crud/earning-stats/delete/%s\">Delete</a>", $record->getId());
            }
        ));
    }
    ...
    protected function initFilters($query)
    {
        ...
        $value = $this->getParamAdapter()->getValueOfFilter('time');
        if ($value != null) {
