<?php
/**
 * This file is generated automatically for table "country". Do not change its
...
class BaseCountryGrid extends \ZfTable\AbstractTable
{
    ...
    public function init()
    {
        ...
        $this->getHeader("edit")->getCell()->addDecorator("callable", array(
            "callable" => function($context, $record){
                return sprintf("<a href=\"/admin/crud/country/update/%s\">Edit</a>", $record->getId());//id
            }
        ));

        $this->getHeader("delete")->getCell()->addDecorator("callable", array(
            "callable" => function($context, $record){
                return sprintf("<a href=\"/admin/crud/country/delete/%s\">Delete</a>", $record->getId());
            }
        ));
    }
