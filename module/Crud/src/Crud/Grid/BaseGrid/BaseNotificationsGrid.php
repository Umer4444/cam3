<?php
/**
 * This file is generated automatically for table "notifications". Do not change
...
class BaseNotificationsGrid extends \ZfTable\AbstractTable
{
    ...
    public function init()
    {
        ...
        $this->getHeader("edit")->getCell()->addDecorator("callable", array(
            "callable" => function($context, $record){
                return sprintf("<a href=\"/admin/crud/notifications/update/%s\">Edit</a>", $record->getId());//id
            }
        ));

        $this->getHeader("delete")->getCell()->addDecorator("callable", array(
            "callable" => function($context, $record){
                return sprintf("<a href=\"/admin/crud/notifications/delete/%s\">Delete</a>", $record->getId());
            }
        ));
    }
