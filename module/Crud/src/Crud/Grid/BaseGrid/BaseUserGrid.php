<?php
/**
 * This file is generated automatically for table "user". Do not change its
...
class BaseUserGrid extends \ZfTable\AbstractTable
{
    ...
    public function init()
    {
        ...
        $this->getHeader("edit")->getCell()->addDecorator("callable", array(
            "callable" => function($context, $record){
                return sprintf("<a href=\"/admin/crud/user/update/%s\">Edit</a>", $record->getId());//id
            }
        ));

        $this->getHeader("delete")->getCell()->addDecorator("callable", array(
            "callable" => function($context, $record){
                return sprintf("<a href=\"/admin/crud/user/delete/%s\">Delete</a>", $record->getId());
            }
        ));
    }
    ...
    protected function initFilters($query)
    {
        ...
        $value = $this->getParamAdapter()->getValueOfFilter('referral_code');
        if ($value != null) {
            $query->where("referral_code like '%".$value."%' ");
        }
        ...
        $value = $this->getParamAdapter()->getValueOfFilter('chips_privacy');
        if ($value != null) {
            $query->where("chips_privacy like '%".$value."%' ");
        }
